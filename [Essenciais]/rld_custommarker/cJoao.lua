...
function MarkerStreamer:updateTarget(marker, icon, r, g, b, data)
  ...
  dxDrawImage(250, 0, 200, 200, self:getIcon("marker"), 0, 0, 0, tocolor(0, 122, 252, 255))
  dxDrawImage(286, 20, 128, 128, markerIcon, 0, 0, 0, iconName == "logo" and tocolor(255, 255, 255, 255) or tocolor(0, 122, 252, 255))
